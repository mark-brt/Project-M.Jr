...
A resposta determina qual template de regras aplicar (ver `templates/perfis/`). No Codex,
adaptar o conteudo para `AGENTS.md`; manter `CLAUDE.md` apenas como compatibilidade com o curso.
...
### `AGENTS.md`
Pegar o template correspondente ao perfil escolhido na Fase 1 (`templates/perfis/claude-md-<perfil>.md`),
adaptar com o nome do negócio e estrutura de pastas mencionada nas respostas, converter as referencias
de Claude para Codex, e sobrescrever o `AGENTS.md` da raiz.

Manter `CLAUDE.md` no projeto sem apagar, porque ele ajuda a acompanhar aulas e materiais feitos para Claude Code.
